...
def verify():
    ...
    try:
        # Setup dummy data
        cycle = "Verify Cycle"
        campus = "Verify Campus"
        program_level = "UG"

        # Cleanup existing if any
        frappe.db.delete("Merit Rule", {"rule_name": "Verify Rule"})
        ...
        assert "V-APP-001" in applicants, "V-APP-001 should be in the list"
        assert "V-APP-002" not in applicants, "V-APP-002 should NOT be in the list"
