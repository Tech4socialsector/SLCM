...
def execute(filters: dict | None = None):
	...
	total_absent = sum(d.get("absent_count", 0) for d in data)

	summary = [
		{
			"label": _("Total Absent Applicants"),
			"value": total_absent,
			"indicator": "Red",
			"datatype": "Int",
		}
	...
	message = (
		_("Absent applicant counts by centre.")
		if data
		else _("No absent applicants found.")
	)
