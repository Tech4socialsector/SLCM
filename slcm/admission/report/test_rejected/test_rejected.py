...
def execute(filters: dict | None = None):
	...
	total_rejected = sum(d.get("rejected_count", 0) for d in data)

	summary = [
		{
			"label": _("Total Rejected Applicants"),
	...
	message = (
		_("Rejected applicant counts by centre.")
		if data
		else _("No rejected applicants found.")
	)
...
def get_data(filters: dict) -> list[dict]:
	...
	conditions = [
		"(shortlisted_status = 'Rejected' OR entrance_test_status = 'Rejected')",
		"docstatus < 2",
	]
	values = {}
