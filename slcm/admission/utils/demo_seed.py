    ...
    templates = [
        {
            ...
            "subject": "Application Received — {{program}} | {{applicant_id}}",
            "body": """Dear {{candidate_name}},

Thank you for applying to {{program}} at National Law School of India University.

Your application ID is <b>{{applicant_id}}</b>.
...
NLSIU""",
        ...
        },
        {
            ...
            "subject": "Application Update — {{program}} | {{applicant_id}}",
            "body": """Dear {{candidate_name}},
...
NLSIU""",
        ...
        },
        {
            ...
            "subject": "Admission Offer — {{program}} | {{applicant_id}}",
            "body": """Dear {{candidate_name}},
...
NLSIU""",
        ...
        },
        {
            ...
            "subject": "Interview Scheduled — {{program}} | {{applicant_id}}",
            "body": """Dear {{candidate_name}},
