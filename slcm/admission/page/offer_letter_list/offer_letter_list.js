...
class OfferLetterList {
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 pt-3 border-top">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="${new Date(offer.payment_deadline) < new Date() ? 'text-danger' : 'text-warning'}">
    ...
    start_timers() {
        ...
        const update_timers = () => {
            this.wrapper.find('.offer-timer-chip').each(function () {
                const $this = $(this);
                ...
                if (distance < 0) {
                    $this.css('background', '#e53e3e').text(__('EXPIRED'));
                    return;
                }
        ...
        this.timer_interval = setInterval(update_timers, 1000);
        update_timers();
    }
