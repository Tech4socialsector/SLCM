...
def on_applicant_submit(doc, method):
    ...
    frappe.sendmail(
        ...
        subject=f"NLSIU Application Submitted - {doc.application_id}",
        message=f"""
            ...
            You will be notified of further updates through this email and your portal.<br><br>
...
def on_merit_list_publish(doc, method):
    ...
    applicants = frappe.get_all("Merit List Entry", {
        "parent": doc.name,
        "status": "Listed"
    }, ["applicant"])
...
def send_deadline_reminders():
    ...
    rounds = frappe.get_all("Admission Round", {
        "status": "Active",
    ...
    for round_doc in rounds:
        ...
        for applicant in applicants:
            frappe.sendmail(
                ...
                Please complete and submit your application before the deadline.<br><br>
                NLSIU Admissions Team
                """
            )
