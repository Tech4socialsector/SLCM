	...
	$body.html(`
		<div class="er2-wrap" style="padding:20px 24px;">
			...
			<div class="er2-coming-card">
				<div class="er2-coming-icon" style="background:linear-gradient(135deg,#f5f3ff,#ede9fe);">
					<svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="1.8">
						<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
					</svg>
				</div>
				<div class="er2-coming-title">Publish Results</div>
				<div class="er2-coming-desc">
					Bulk publish or unpublish results for students, control portal visibility
					per exam plan or course, and manage result release schedules.
				</div>
