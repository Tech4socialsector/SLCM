...
content = [
    ...
    {"id":"mst_h2",       "type":"paragraph", "data":{"text": hdr("&#128218;","Course &amp; Calendar"),   "col":12}},
    {"id":"mst_sc_curr",  "type":"shortcut",  "data":{"shortcut_name":"Course List",       "col":3}},
...
shortcuts = [
    ...
    {"color":"Green",  "doc_view":"List","label":"Course List",             "link_to":"Course List",              "type":"DocType"},
...
links = [
    ...
    {"label":"Course List",              "link_to":"Course List",              "link_type":"DocType","onboard":1,"type":"Link","hidden":0,"is_query_report":0},
