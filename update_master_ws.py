...
content = [
    ...
    {"id":"mst_sc_sg",    "type":"shortcut",  "data":{"shortcut_name":"Student Group",     "col":4}},
...
shortcuts = [
    ...
    {"color":"Purple", "doc_view":"List","label":"Student Group",            "link_to":"Student Group",            "type":"DocType"},
...
links = [
    ...
    {"label":"Student Group",            "link_to":"Student Group",            "link_type":"DocType","onboard":0,"type":"Link","hidden":0,"is_query_report":0},
