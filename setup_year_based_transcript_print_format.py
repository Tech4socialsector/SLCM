...
Run this from the frappe-bench directory: bench execute slcm.setup_year_based_transcript_print_format.setup
"""
...
def setup():
    ...
    try:
        ...
        frappe.throw(_("HTML template file not found at {0}").format(html_template_path))
        return
