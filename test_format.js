...
console.log(format_superscript_subscript("A^+"));
console.log(format_superscript_subscript("B_-"));
console.log(format_superscript_subscript("A<sup>+</sup>"));
console.log(format_superscript_subscript("A<sub>+</sub>"));
